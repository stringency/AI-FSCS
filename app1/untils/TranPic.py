...
max_dim = 800
# 内容图片路径
content_path = '../static/tmp/funtion/TranPic/input/gzt2.jpg'
# 风格图片路径
style_path = '../static/tmp/funtion/TranPic/input/style.jpg'
# 风格权重
style_weight=10
# 内容权重
content_weight=1
...
for n in range(stpes):
    ...
    if n%50==0:
        ...
        if save_img==True:
            ...
            # 设置保存路径保存图片
            s_image.save('../tmp/funtion/TranPic/output/'+'steps_'+str(n)+'.jpg')
